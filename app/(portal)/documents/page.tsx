...
const AdminDocuments = ({ data }: { data: z.infer<typeof AdminDocumentsSchema> }) => {
  return (
    <div className="grid gap-4">
      <div className="flex items-center justify-between rounded-2xl bg-[#19615C] px-14 py-3">
      ...
      <Card className="grid flex-1 w-full">
        <CardHeader className='grid gap-2'>
          ...
          <div className="grid gap-4">
            ...
            <p className='px-4'>{user.application.feedback ? user.application.feedback : 'No feedback provided yet!'}</p>
          </div>
        </CardHeader>
        <Separator />
